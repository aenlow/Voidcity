...
export const OBJECT_TYPES = {
  ...
  // ---- added in v1.1: variety pass -------------------------------------
  crate: def({ id: 'crate', name: 'Crate', size: 11, mass: 26, value: 24, cls: 'light', height: 18, color: '#8a6a41', tags: ['industrial', 'stackable'] }),
  barrel: def({ id: 'barrel', name: 'Oil barrel', size: 9, mass: 30, value: 28, cls: 'light', shape: 'circle', height: 20, color: '#4a6a52', tags: ['industrial', 'stackable'] }),
  pallet: def({ id: 'pallet', name: 'Pallet stack', size: 14, w: 34, h: 30, mass: 34, value: 26, cls: 'light', height: 12, color: '#93764c', tags: ['industrial', 'stackable'] }),
  hedge: def({ id: 'hedge', name: 'Hedge', size: 13, w: 40, h: 16, mass: 26, value: 18, cls: 'light', height: 14, color: '#3f6b45', tags: ['park'] }),
  phonebooth: def({ id: 'phonebooth', name: 'Phone booth', size: 8, mass: 38, value: 34, cls: 'light', height: 30, color: '#2f6f8f', tags: ['street'] }),
  acunit: def({ id: 'acunit', name: 'AC unit', size: 9, w: 22, h: 18, mass: 44, value: 30, cls: 'medium', height: 12, color: '#93a0b4', tags: ['rooftop', 'stackable'] }),
  newsstand: def({ id: 'newsstand', name: 'Newsstand', size: 13, w: 30, h: 22, mass: 70, value: 52, cls: 'medium', height: 24, color: '#b5543f', tags: ['street'] }),
  taxi: def({ id: 'taxi', name: 'Taxi', size: 15, w: 44, h: 20, mass: 120, value: 95, cls: 'medium', height: 16, color: '#e0b13a', tags: ['car', 'vehicle'] }),
  forklift: def({ id: 'forklift', name: 'Forklift', size: 14, w: 32, h: 22, mass: 150, value: 110, cls: 'medium', height: 24, color: '#d98b2b', tags: ['vehicle', 'industrial'] }),
  billboard: def({ id: 'billboard', name: 'Billboard', size: 24, w: 56, h: 10, mass: 210, value: 180, cls: 'medium', height: 52, color: '#6d6f86', tags: ['street'] }),
  pylon: def({ id: 'pylon', name: 'Power pylon', size: 18, w: 30, h: 30, mass: 340, value: 240, cls: 'heavy', height: 96, color: '#8b93a6', tags: ['industrial'] }),
  rv: def({ id: 'rv', name: 'Motorhome', size: 26, w: 78, h: 28, mass: 520, value: 320, cls: 'heavy', height: 30, color: '#cfd3dd', tags: ['vehicle'] }),
  fountain: def({ id: 'fountain', name: 'Fountain', size: 28, mass: 780, value: 430, cls: 'heavy', shape: 'circle', height: 16, color: '#7d8aa0', tags: ['park', 'landmark-ish'] }),
  tram: def({ id: 'tram', name: 'Tram', size: 40, w: 118, h: 26, mass: 1150, value: 620, cls: 'heavy', height: 32, color: '#c25a4a', tags: ['vehicle'] }),
  radiomast: def({ id: 'radiomast', name: 'Radio mast', size: 20, w: 34, h: 34, mass: 1600, value: 880, cls: 'heavy', height: 150, color: '#a2a9ba', tags: ['industrial'] }),
  crane: def({ id: 'crane', name: 'Tower crane', size: 34, w: 60, h: 60, mass: 4200, value: 2100, cls: 'massive', height: 168, color: '#d8b441', tags: ['industrial', 'big'] }),
